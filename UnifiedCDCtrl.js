        ...
        $http.post(url, {
            ...
            id: i
                ...
                success(function (data, status, headers, config) {
                    ...
                    $scope.contracts.results[0]['color'] = '#1E3067';
                    $scope.contracts.results[0]['display'] = true;

                    $scope.contracts.results[0]['collapsed1'] = 'Contract: ' + $scope.contracts.results[0].type;
                    $scope.contracts.results[0]['collapsed2'] = 'Network: ' + $scope.contracts.results[0].type;
                    $scope.contracts.results[0]['collapsed3'] = 'Type: ' + $scope.contracts.results[0].type;
            ...
            AgreementGlossaryOfTermsId: i
                ...
                success(function (data, status, headers, config) {
                    ...
                    $scope.tempGresults = {
                        ...
                        color: '#007810',
                        collapsed1: 'Glossary: ' + $scope.glossary.glossresults[0].GlossaryTerm,
                        collapsed2: 'Contract: ' + $scope.glossary.glossresults[0].NctcAgreementName
                    };
...
// *  RIGHT COLUMN CONTROLS - START * //
    ...
    $scope.collapseArray = function (display) {
        // works to collapse entire rightColArray
        console.log($scope.rightColArray);
        angular.forEach($scope.rightColArray, function (rightColArray) {
            rightColArray.display = false;
            console.log(rightColArray.display);
        });
    };
